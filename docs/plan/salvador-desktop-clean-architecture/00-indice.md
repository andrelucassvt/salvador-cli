...
| 2 | `02-domain-data.md` | Interfaces de Repository e suas implementações (Ollama, Chat/Agente, Workspace) mais `DesktopStorageService`, todos testados com fakes | não — abre os contratos de Repository consumidos pelos Cubits na parte 3/4 | 1 | pendente |
