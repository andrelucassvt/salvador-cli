...
| 3 | `03-assistente-e-acoes.md` | Assistente Git contextual, propostas aprováveis e ações locais tipadas com atualização dos flows | não — integra contratos do núcleo, sessão do agente, estado e UI no mesmo fluxo | 1 e 2 | concluída — commit `2c576e7` |
